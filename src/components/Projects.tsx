	...
	return (
		<section id="projects" className="space-y-6">
			...
			<div className="flex flex-col md:flex-row gap-x-6 gap-y-2">
				...
				<div className="w-full">
					<h4 className="font-medium text-zinc-800 dark:text-zinc-100 mb-2">
						Sahabat Kampus – Sistem Informasi Kos
					</h4>

					<p className="text-sm text-zinc-500 dark:text-zinc-300 leading-relaxed">
						Sahabat Kampus adalah sistem informasi kos sekitar kampus yang menampilkan 
						daftar kos lengkap beserta lokasi, harga, dan fasilitas. Tampilan dibuat 
						modern dengan nuansa biru, responsif, dan ramah pengguna. Project ini 
						dibangun menggunakan PHP Native, CSS, dan MySQL, serta dilengkapi 
						halaman beranda, panduan, info kos, forum, dan sistem login.
					</p>
